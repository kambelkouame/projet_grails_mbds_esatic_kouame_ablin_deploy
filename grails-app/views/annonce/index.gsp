...
-->
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Annonce list</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-muted">Annonce list</li>
									</ul>
									<!--end::Breadcrumb-->
								</div>
								<!--end::Page title-->
									...
									<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
										...
										<li class="nav-item ms-auto">
											...
											<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
												...
												<a href="/illustration/index" class="btn btn-primary ps-7"  data-kt-menu-placement="bottom-end">show illustration
											<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
												...
												<div class="card-header border-0">
													...
													<div class="card-toolbar">
														<!--begin::Filter-->
															...
															<a href="/illustration/create" >	<button type="button" class="btn btn-sm btn-flex btn-light-primary"  data-bs-target="#kt_modal_add_payment">
														...
														<!--end::Svg Icon-->Add illustration for Annonce</button> 
											</a>
														<!--begin::Svg Icon | path: icons/duotune/general/gen035.svg-->
                    ...
                    ${user.username}
															...
															<td> <g:link controller="annonce" action="show" id="${annonce.id}"><button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Show</button>
											<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
										</g:link></td>
															</tr>
                                                              </g:each>
