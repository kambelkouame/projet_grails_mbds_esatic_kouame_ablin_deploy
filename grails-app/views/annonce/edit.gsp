						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Update Annonce</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div id="kt_account_profile_details" class="collapse show">
									   <div class="row mb-6">
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="text" name="description" required="" value="" id="description" placeholder="description"  class="form-control form-control-lg form-control-solid" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="number" name="price" required="" value="" id="price" placeholder="price"  class="form-control form-control-lg form-control-solid" />
												</div>
												<!--end::Col-->
											</div>
