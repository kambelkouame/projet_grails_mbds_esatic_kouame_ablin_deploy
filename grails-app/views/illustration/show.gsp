												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<a class="menu-link active py-3" href="../../demo6/dist/apps/customers/view.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Illustration details</span>
																</a>
															</div>
														</div>
													</div>
...
-->
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Illustration details</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">create illustration</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-200 w-5px h-2px"></span>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">show illustration</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
								...
								<div class="flex-lg-row-fluid ms-lg-15">
									...
									<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
										...
										<li class="nav-item ms-auto">
											<!--begin::Action menu-->
											<a href="/" class="btn btn-primary ps-7"  data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">Home
											<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
											...
											<div class="card pt-4 mb-6 mb-xl-9">
												...
												<div class="card-header border-0">
													...
													<div class="card-toolbar">
														<!--begin::Filter-->
													<a href="/illustration/create">	<button type="button" class="btn btn-sm btn-flex btn-light-primary">
														...
														<!--end::Svg Icon-->new Illustration</button></a>	
														<!--end::Filter-->
													</div>
													<!--end::Card toolbar-->
												</div>
													...
													<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
														...
														<tbody class="fs-6 fw-bold text-gray-600">
															...
															<tr>
																<!--begin::Invoice=-->
																<td>
																	<a href="#" class="text-gray-600 text-hover-primary mb-1">${illustration.filename} <img src="${grailsApplication.config.assets.url + illustration.filename}"/></a>
		...
		<asset:javascript src="add-payment.js" ></asset:javascript>
		<asset:javascript src="adjust-balance.js" ></asset:javascript>
		<asset:javascript src="invoices.js" ></asset:javascript>

        	<asset:javascript src="payment-method.js" ></asset:javascript>
		<asset:javascript src="payment-table.js" ></asset:javascript>
		<asset:javascript src="statement.js" ></asset:javascript>

    	<asset:javascript src="update.js" ></asset:javascript>
		<asset:javascript src="new-card.js" ></asset:javascript>
