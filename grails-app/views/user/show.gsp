						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">User Overview</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">user Overview</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
								...
								<div class="card-header cursor-pointer">
									...
									<div class="card-title m-0">
										<h3 class="fw-bolder m-0">users Details</h3>
									</div>
									<!--end::Card title-->
                            ...
                            <g:form resource="${this.user}" method="DELETE">
                                        <fieldset class="buttons">
                                            <g:link class="edit" action="edit" class="btn btn-warning align-self-center" resource="${this.user}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                                            <input  class="btn btn-sm btn-flex btn-light-danger" class="delete"   type="submit" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                                        </fieldset>
                                    </g:form>
									<!--begin::Action-->
								...
								<div class="card-body p-9">
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 fv-row">
											<span class="fw-bold text-gray-800 fs-6">${user.getAuthorities()*.authority.join(',')}</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-7">
										<!--begin::Label-->
										<label class="col-lg-4 fw-bold text-muted">Annonces
										<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Phone number must be active"></i></label>
										<!--end::Label-->
										<!--begin::Col-->
										<div class="col-lg-8 d-flex align-items-center">

											<g:each in="${user.annonces}" var="annonce"><span class="badge badge-success"><g:link controller="annonce" action="show" id="${annonce.id}">${annonce.title}  </g:link></span> <br/></g:each>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
