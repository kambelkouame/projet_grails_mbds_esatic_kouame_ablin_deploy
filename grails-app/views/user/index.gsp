...
<html lang="en">
	...
	<head><base href="../../">
        ...
        <asset:stylesheet src="datatables.bundle.css" ></asset:stylesheet>
        <asset:stylesheet src="plugins.bundle.css" ></asset:stylesheet>
        <asset:stylesheet src="style.bundle.css" ></asset:stylesheet>
				...
				<div id="kt_aside" class="aside pb-5 pt-5 pt-lg-0" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'80px', '300px': '100px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo py-8" id="kt_aside_logo">
						...
						<a href="#" class="d-flex align-items-center">
							  <asset:image src="logo-demo6.svg" absolute="true"></asset:image>
						</a>
						<!--end::Logo-->
					</div>
					<!--end::Brand-->
							...
							<div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-2">
									<span class="menu-link  menu-center" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										...
										<span class="menu-title">Annoncement</span>
									</span>
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
											<div class="menu-item">
											<div class="menu-content">
												<span class="menu-section fs-5 fw-bolder ps-1 py-1">Annonce</span>
											</div>
										</div>
										<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="/annonce/index">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Anoncement Liste</span>
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="/annonce/create">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Create Annonce</span>
													</a>
												</div>
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-2">
									<span class="menu-link   menu-center" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										...
										<span class="menu-title">Illustration</span>
									</span>
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										<div class="menu-item">
											<div class="menu-content">
												<span class="menu-section fs-5 fw-bolder ps-1 py-1">Illustration</span>
											</div>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="/illustration/index">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">illustration list</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="/illustration/create">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">create illustration</span>
											</a>
										</div>
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-2">
									<span class="menu-link active menu-center" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon  me-0">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link" href="/user/create">
												...
												<span class="menu-title">Creer un utilisateur</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="/user/index">
												...
												<span class="menu-title">Voir la liste des utilisateurs</span>
											</a>
										</div>
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<a class="menu-link active py-3" href="../../demo6/dist/apps/customers/list.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
...
-->
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											<!--end::Export-->
											<!--begin::Add customer-->
											<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer"><a href="/user/create" class="menu-link px-3"> Ajouter un utilisateur</a></button>
											<!--end::Add customer-->
										</div>
										<!--end::Toolbar-->
										<!--begin::Group actions-->
									...
									<div class="card card-xl-stretch mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder text-dark"><g:link controller="user" action="show" id="${user.id}">${user.username}</g:link></span>
												<span class="text-muted mt-1 fw-bold fs-7">Liste de toute les annonces</span>
											</h3>
											<div class="card-toolbar">
												<!--begin::Menu-->
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
													<!--begin::Heading-->
													<div class="menu-item px-3">
														<div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">gestion</div>
													</div>
													<!--end::Heading-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3">modifier le profile</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Details du profile
											...
											<div class="d-flex align-items-sm-center mb-7">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
													 <asset:image src="logo-demo6.svg"  class="h-50 align-self-center" alt=""></asset:image>
												...
												<div class="d-flex align-items-center flex-row-fluid flex-wrap">
													<div class="flex-grow-1 me-2">
														<a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder"><g:link controller="annonce" action="show" id="${annonce.id}">${annonce.title}</g:link></a>
														<span class="text-muted fw-bold d-block fs-7"><g:link controller="annonce" action="show" id="${annonce.id}">${annonce.description}</g:link></span>
													</div>
													<span class="badge badge-light fw-bolder my-2"><g:link controller="annonce" action="show" id="${annonce.id}">${annonce.price} $ </g:link></span>
												</div>
												<!--end::Section-->
											</div>
												</g:each>
    ...
    <g:if test="${flash.message}">
		...
		<asset:javascript src="plugins.bundle.js" ></asset:javascript>
		<asset:javascript src="scripts.bundle.js" ></asset:javascript>
		<asset:javascript src="datatables.bundle.js" ></asset:javascript>
		<asset:javascript src="export.js" ></asset:javascript>
		<asset:javascript src="list.js" ></asset:javascript>
		<asset:javascript src="add.js" ></asset:javascript>
		<asset:javascript src="widgets.js" ></asset:javascript>

		<asset:javascript src="chat.js" ></asset:javascript>
		<asset:javascript src="create-app.js" ></asset:javascript>
		<asset:javascript src="upgrade-plan.js" ></asset:javascript>
