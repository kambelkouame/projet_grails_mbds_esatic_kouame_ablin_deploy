											...
											<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															<div class="menu-item">
																<a class="menu-link active py-3" href="../../demo6/dist/account/overview.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Overview</span>
...
-->
				...
				<g:hasErrors bean="${this.user}">
					...
					<!--begin::Basic info-->
					 ...
					 <g:form resource="${this.user}"  class="form" method="POST">
							<div class="card mb-5 mb-xl-10">
								...
								<div id="kt_account_profile_details" class="collapse show">
												...
												<div class="col-lg-8">
													...
													<div class="row">
														...
														<div class="col-lg-8 fv-row">
															<input type="text" name="username" value="" required="" id="username" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Username" />
														</div>
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="password" name="password" required="" value="" id="password" placeholder="password"  class="form-control form-control-lg form-control-solid" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
                                                 ...
                                                 <g:select name="role" from="${roles}" optionKey="id" optionValue="authority"  class="form-select form-select-solid form-select-lg" data-control="select2"/>
												</div>
												<!--end::Col-->
											</div>
